                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col d-flex justify-content-end">
                                <a href="{{ route('course.manage', $data['course_id']) }}"
                                    class="btn btn-sm btn-outline-primary">Manage <span
                ...
                <div class="modal-body">
                    <form action="{{ route('course.create') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="course_name" value="{{ old('course_name') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="course_code" value="{{ old('course_code') }}"
